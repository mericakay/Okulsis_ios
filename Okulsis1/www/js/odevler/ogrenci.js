...
function load() {
    ...
    try {
        $.ajax({
            url: 'http://' + ip + '/Slim_Proxy_okulsis/SlimProxyBoot.php?url=OdevListesiOgrenciveYakin_mbllogin&ogrenciID=' + kisiid + '&cid=' + cid + '&lid=' + lid + '&did=' + did + '&egitimYilID=' + egitimyiliid + '&donemID=' + gelendonem + '',
            type: 'GET',
            dataType: 'json',
            success: function (data) {
