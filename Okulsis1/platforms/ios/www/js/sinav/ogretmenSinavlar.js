...
function load() {
    ...
    try {
        $.ajax({
            ...
            url: 'http://' + ip + '/Slim_Proxy_okulsis/SlimProxyBoot.php?url=Ogretmensinavlistesi_mbllogin&ogretmenID=' + kisiid + '&egitimYilID=' + egitimyiliid + '&okulID=' + okulid + '&kisiID=' + kisiid + '&cid=' + cid + '&lid=' + lid + '&donemID=' + gelendonem + '&did=' + did + '&grid=1',
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                var j;
